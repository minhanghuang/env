...
git clone --depth 1 git@github.com:wting/autojump.git ~/.oh-my-zsh/custom/plugins/autojump
git clone --depth 1 git@github.com:zsh-users/zsh-completions.git ~/.oh-my-zsh/custom/plugins/zsh-completions
git clone --depth 1 git@github.com:junegunn/fzf.git ~/.fzf && ~/.fzf/install
